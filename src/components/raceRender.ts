export default class RaceRender {
    template: string;
    ...
    <div class = "buttons_wraper">
        <button class="button button-car_select">Select</button>
        <button class="button button-car_remove">Remove</button>
        <h4 clas="car-name"></h4>
    </div>
<button class="button button_like-light button-car_start">A</button>
<button class="button button_like-light button-car_stop">B</button>
<div class='car_wrapper'>

    <svg class="car" width="110" height="40" fill="none" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
    xmlns="http://www.w3.org/2000/svg" xmlns:cc="http://creativecommons.org/ns#"
    xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:svg="http://www.w3.org/2000/svg" id="svg2"
    viewBox="0 0 167.83 55.332" version="1.0">
    <g id="layer1" transform="translate(-227.51 -167.55)">
      <path id="path2220" fill-rule="evenodd"
...
<div class="line"></div>
    ...
    render() {
        ...
        const race: HTMLElement = document.createElement('template');
        race.id = 'car-race';
        race.innerHTML = this.template;
        main?.append(race);
    }
}
